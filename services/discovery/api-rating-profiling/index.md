...
<div class="row gx-xl-9">
  <div class="col-12">
    <section>
      ...
      <!-- Price callout -->
      <div class="p-3 mb-4 rounded-3 d-inline-block" style="background:#eef3fb;border:1px solid #d4def0;border-left:5px solid #0a3d91;">
        <span class="fw-bold fs-5" style="color:#0a3d91;">$2,500</span>
        <span class="text-muted ms-2">— prioritized profiling, done for you</span>
      </div>
      ...
      <div class="mb-2" style="max-width: 46rem;">
        ...
        <p class="mb-3">For $2,500 I audit your public API surface against the full rubric &mdash; both the composite quality facets and the agent-readiness dimensions &mdash; find where you are leaving points on the table, and add the machine-readable artifacts to your API Evangelist repository so the score actually moves. You get a profiled provider, a clear picture of what changed and why, and a surface that reads as first-class to both developers and their agents.</p>
      ...
      <!-- CTA -->
      <div class="mb-4" style="max-width: 46rem;">
        <a href="mailto:kin@apievangelist.com?subject=Prioritized%20API%20Rating%20%26%20Profiling" class="btn btn-primary btn-sm">Get prioritized profiling &mdash; $2,500 &rarr;</a>
      </div>
