  ...
  <div class="col-12">
    <section>
      ...
      <div class="mb-2" style="max-width: 46rem;">
        ...
        <ul class="text-muted">
          <li>CI/CD pipelines that automate both governance and delivery</li>
          <li>Your rules enforced automatically on every change</li>
          <li>Fresher artifacts and catalogs with far less manual effort</li>
        </ul>
      </div>
      ...
      <div class="card border-0 shadow-sm mt-4" style="max-width: 46rem;">
        <div class="card-body">
          ...
          <p class="text-muted mb-3">If your governance and delivery still depend on someone remembering, let's automate it so it just happens.</p>
          <p class="mb-0"><a href="mailto:info@apievangelist.com?subject=Pipelines%20services" class="btn btn-outline-secondary btn-sm">Get in touch — info@apievangelist.com</a></p>
        </div>
      </div>
