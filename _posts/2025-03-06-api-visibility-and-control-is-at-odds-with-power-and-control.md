...
_ Kin Lane, your post really highlights a fundamental challenge in API governance. While many teams rely on Git repositories as their single source of truth, this approach often falls short when it comes to discoverability, lifecycle management, and policy enforcement—especially at scale.
...
_ Do you see a shift towards hybrid models, where repositories remain the authoritative source but registries enhance visibility and control? And what do you think is holding back broader adoption of dedicated API registries in the industry? Looking forward to your thoughts!
