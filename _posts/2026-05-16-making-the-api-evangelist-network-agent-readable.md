...
- **`/apis.json`** — the site's own machine-readable identity in the [APIs.json](https://apisjson.org) format. Name, description, tags, maintainers, support contact, GitHub repo. The "who are you and what do you offer" file an agent reads instead of crawling.
...
I shipped three [Agent Skills](https://agentskills.io) at `apievangelist.com/skills/`:
