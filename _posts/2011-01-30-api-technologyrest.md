...
REST takes advantage of the same Internet mechanisms that are used to view regular web pages, therefore doekinlane-productions2.s3.amazonaws.comotocols to deliver or view REST [APIs](http://www.apievangelist.com/). [![](https://kinlane-images.s3.amazonaws.com/apievangelist/restful_large.png)](http://oreilly.com/catalog/9780596529260) There are different opinions of what is truly REST compliant, and many developers have seem to agree that using existing [HTTP](http://en.wikipedia.org/wiki/Hypertext_Transfer_Protocol "Hypertext Transfer Protocol") mechanisms for your API is considered [RESTful](http://en.wikipedia.org/wiki/Representational_State_Transfer "Representational State Transfer"), regardless of conforming 100% to REST.
