...
tags:
  ...
  - APIs
---
This is the fundamental that most governance programs skip, and skipping it is exactly why most of them fail. Here is the pattern I have watched play out over and over: a team builds a Spectral ruleset, points it at their OpenAPI specs in a pipeline, and calls it a governance program. It is not a governance program. It is the enforcement layer of a governance program with the actual governance program missing. The part they left out — the layer that makes any of it legible to a human who doesn't read YAML — is the policies and the style guide. Without that layer, your engineers see lint errors with no reasons attached, and nobody in product or leadership can engage with the work at all.
