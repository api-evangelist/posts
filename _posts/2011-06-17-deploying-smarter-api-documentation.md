...
tags:
  - Documentation
---
kinlane-productions2.s3.amazonaws.com [![](https://kinlane-images.s3.amazonaws.com/apievangelist/posterous/posterous-logo.jpg)](http://www.posterous.com "Posterous")[Posterous](http://www.posterous.com "Posterous") recently launched a [new API](http://apievangelist.com/2011/06/10/posterous-from-saas-to-paas-using-an-api/ "new API") giving users access to all the functionality available through the Posterous web interface.
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/posterous/posterous-api-make-request.png)When logged into your Posterous account, the API documentation automatically includes your api\_token, which is necessary for making API calls.
