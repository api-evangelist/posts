...
API providers like [Twilio](http://www.twilio.com "Twilio") and [Netflix](http://www.netflix.com "Netflix") are using them to attract new users, and to generate buzz and innovation around their API.
