...
tags:
  ...
  - Security
image: >-
  https://kinlane-images.s3.amazonaws.com/apievangelist/elastic-beam/elasticbeam-security.png
---
I'm getting some investment from [ElasticBeam](https://www.elasticbeam.com/) to turn up the volume on my [API security research](http://security.apievangelist.com/), so I will be telling more stories on the subject, and publishing an industry guide, as well as a white paper in coming weeks. I want my API security to become a first class area of my API research, along side definitions, design, deployment, management, monitoring, testing, and performance.
