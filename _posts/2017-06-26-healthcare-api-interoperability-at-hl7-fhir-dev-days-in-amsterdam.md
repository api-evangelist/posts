...
tags:
  ...
  - API Evangelist
image: >-
  https://kinlane-images.s3.amazonaws.com/apievangelist/fhir/fhir-devdays-2017-amsterdam.png
author:
  name: kinlane
---
<p><a href="https://www.fhirdevdays.com/"><img src="https://kinlane-images.s3.amazonaws.com/apievangelist/fhir/fhir-devdays-2017-amsterdam.png" align="right" width="40%" style="padding: 15px;" /></a></p>[I wrote about a machine learning specific API event a couple weeks back](https://apievangelist.com/2017/06/07/a-conference-focused-on-machine-learning-apis/), and today I wanted to highlight the growth of conferences dedicated to [FHIR, or the Fast Healthcare Interoperability Resources](https://www.hl7.org/fhir/). FHIR is larger than just it's API, but it is one very important example of how APIs and open industry API specifications can help move forward the API conversation in large industries.
