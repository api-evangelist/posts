...
I have been adding the pieces of the agentic stack to the [API Evangelist standards catalog](https://providers.apievangelist.com) as they mature — the [Model Context Protocol](https://providers.apievangelist.com/providers/model-context-protocol) itself, [mcp.json](https://providers.apievangelist.com/providers/mcp-json), [Arazzo](https://providers.apievangelist.com/providers/arazzo) for workflows, the [agents.md](https://providers.apievangelist.com/providers/agents-md) family — because I want the description and governance layer for agents to be as boring and well-understood as it is for APIs. mcpdesc slots right in as [its own entry](https://providers.apievangelist.com/providers/mcpdesc). It is early, it is at v0.9.0, and the tooling ecosystem is still forming, but the shape is right and the intent is exactly what this moment needs.
