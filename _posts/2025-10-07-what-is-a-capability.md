...
- Clear Boundaries - Capabilities possses clear separations of concern for what it does.
...
- Discoverable - Capbailities posses rich metadata that always enabling discovery.
...
- Automated - Capabilities can be audomated via scheduling, events, and pipelines.
...
- Traceable - The fingerprints of a cabability should be anywhere it is used.
...
- Sharable - Capabilites are easily shared using native capabilities where found.
...
- Semantics - Capabilities posses the semantics required to understand what it does.
