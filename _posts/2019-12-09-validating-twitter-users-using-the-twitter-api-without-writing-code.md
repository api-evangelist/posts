...
image: >-
  https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-status-lookup/see-visual-response.png
author:
  name: kinlane
tags:
  - Twitter
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-status-lookup/twitter-application.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-status-lookup/twitter-keys-and-tokens.jpg)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-status-lookup/edit-collection.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-status-lookup/edit-collection-authorization.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-status-lookup/make-response.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-status-lookup/see-response.png)
