...
tags:
  ...
  - Code
---
kinlane-productions2.s3.amazonaws.com ![](https://kinlane-images.s3.amazonaws.com/apievangelist/programming-languages/php.gif)An important tone of my blog is not to ever say any API owner should, or developers have to do anything. kinlane-productions2.s3.amazonaws.comrve, discuss and explore the business of APIs.

I was discussing best practices around API ecosystems with a prominent developer the other night an a O'Reilly Web 2.0 event. He had an interesting perspective on how to build community around an API. ![](https://kinlane-images.s3.amazonaws.com/apievangelist/programming-languages/ruby-logo.png) Building your API community can start with your code libraries.
...
His argument was that if an API owner releases an official set of libraries, the innovation stops there. Nobody will build any further code libraries and possibly improve on them. ![](https://kinlane-images.s3.amazonaws.com/apievangelist/programming-languages/python.jpg) By allowing the community to build API libraries it gives you a chance to put the spotlight on developers, increases the chance for competition, spurs innovation and developers will rise to the occasion.
