...
tags:
  ...
  - Open Source
image: >-
  https://kinlane-images.s3.amazonaws.com/shared/copper-circuit-times-square-corner.jpeg
---
...
- [**OpenAPI**](https://schemas.sourcemeta.com/openapi) - Validating your OpenAPIs at all stages.
- [**JSON Schema**](https://schemas.sourcemeta.com/jsonschema) - Inception level validation of schema.
- [**Spectral Rules**](https://github.com/stoplightio/spectral/blob/develop/packages/core/src/ruleset/meta/rule.schema.json) - Making sure your rules are valid.
- [**Vacuum Rules**](https://schemas.sourcemeta.com/pb33f/vacuum) - Validating next generation rules.
- [**APIs.json**](https://schemas.sourcemeta.com/apis-json) - Ensuring the discovery of APIs is valid.
...
<center><a href="https://bit.ly/3CUAlFD"><img src="https://kinlane-images.s3.amazonaws.com/apievangelist/sourcemeta-schemas-registry.png" style="width: 100%;"></a></center>
