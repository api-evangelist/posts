...
You need to make information accessible kinlane-productions2.s3.amazonaws.comn a way that's self-service so you can avoid emailing a spreadsheet every time someone asks for something. ![](https://kinlane-images.s3.amazonaws.com/apievangelist/api-evangelist/matrix-data-streaming-api.jpg) You do this with a data API. Data [APIs](http://www.apievangelist.com/) can:
