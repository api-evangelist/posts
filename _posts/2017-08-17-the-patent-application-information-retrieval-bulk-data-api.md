...
tags:
  ...
  - Federal Government
image: >-
  https://kinlane-images.s3.amazonaws.com/apievangelist/uspto/uspto-pair-bulk-data-api.png
---
I stumbled across [the Patent Application Information Retrieval Bulk Data API](https://pairbulkdata.uspto.gov/) from the US Patent Office the other day. It provides a much more usable approach to getting at patent information than what I am using at the moment. Right now I am downloading XML files and searching for the occurrence of a handful of keywords. If I want to make a change I have to fire up a new AWS instance, change the code, and reprocess the downloaded files. The Patent Application Information Retrieval Bulk Data API gives me a much more efficient interface to work with.
