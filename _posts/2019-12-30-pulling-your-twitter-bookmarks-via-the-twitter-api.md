...
image: >-
  https://kinlane-images.s3.amazonaws.com/shared/nazi-invasion-border-crossing-through-fence.jpg
author:
  name: kinlane
tags:
  - Twitter
...
[![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-bookmarks/0-postman-interceptor.png)](https://chrome.google.com/webstore/detail/postman-interceptor/aicmkgpgakddgnaphhhpliifpcfhicfo?hl=en)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-bookmarks/1-postman-workspace.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-bookmarks/2-new-postman-collection.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-bookmarks/3-postman-proxy-corner.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-bookmarks/4-postman-proxy-source.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-bookmarks/5-postman-proxy-capture.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-bookmarks/6-postman-proxy-save-requests-to.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-bookmarks/7-chrome-postman-interceptor.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-bookmarks/8-postman-collection-bookmark-filter.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-bookmarks/9-postman-collection-bookmark-headers.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-bookmarks/10-postman-collection-save-bookmark.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-bookmarks/11-postman-collection-delete-collection.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-bookmarks/12-postman-collections-json-response.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-bookmarks/13-postman-collections-test-tab.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/postman-tutorials/twitter-bookmarks/14-postman-collection-visualizer.png)
