...
image: https://kinlane-images.s3.amazonaws.com/apievangelist/blog/card-sample-image.png
author:
  name: kinlane
tags:
- Print
---
kinlane-productions2.s3.amazonaws.com ![ alt=](https://kinlane-images.s3.amazonaws.com/shared/mimeo/card-sample-image.png)The Mimeo Connect Card Printing API allows developers to submit PDF files, and order commercially printed cards in different sizes, paper and coatings from within your web and mobile applications.
