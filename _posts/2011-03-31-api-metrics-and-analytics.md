...
All three of these providers charge you per transaction for this service. ![](https://kinlane-images.s3.amazonaws.com/apievangelist/Google-Analytics-Charts-Stack.png) To my knowledge there is no provider of an API analytics tool that is free, and plug and play.
