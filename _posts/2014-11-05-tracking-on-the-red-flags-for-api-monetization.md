...
tags:
  ...
  - Monetization
---
I spend my time gathering what I call b"uilding blocks", as I work my way through the API landscape. I’ve been tracking on the [building blocks of API management since 2011](http://management.apievangelist.com/building-blocks.html), and have expanded that to include API [design](http://design.apievangelist.com/building-blocks.html), [deployment](http://deployment.apievangelist.com/building-blocks.html), [evangelism](http://evangelism.apievangelist.com/), [integration](http://integration.apievangelist.com/building-blocks.html) and other areas of the API lifecycle in the last 3 years. I'm working my way through the [700 APIs in my API stack](http://theapistack.com), I am looking for industry focused building building blocks, as well as the ones associated with an APIs business model, or monetization strategy.
