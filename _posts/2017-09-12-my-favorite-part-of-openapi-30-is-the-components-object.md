...
tags:
  ...
  - Design
image: >-
  https://kinlane-images.s3.amazonaws.com/apievangelist/openapi/openapi-30-components-object.png
---
There were a number of changes made to the structure of Open API in the move to version 3.0 that I am a fan of, but if I had to point at a single seismic shift that I think will move the conversation forward it is [the components object](https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.0.md#componentsObject). According to the specification the components object, "holds a set of reusable objects for different aspects of the OAS. All objects defined within the components object will have no effect on the API unless they are explicitly referenced from properties outside the components object." It is the store for for all the common and reusable aspects of defining, and designing your APIs--which will have huge benefits on how we are doing all of this.
