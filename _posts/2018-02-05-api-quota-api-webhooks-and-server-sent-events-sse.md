...
---
<p></p>I am profiling market data APIs as part of my partnership with [Streamdata.io](http://apis.how/streamdata). It is a process I enjoy, because it provides me with a number of interesting stories I can tell here on API Evangelist. Many of the APIs I profile just frustrate me, but there are always the gems who are doing interesting things with their APIs, and understand providing APIs, as well as consuming APIs. One API that I've been profiling, and I am able to put to use in my work to build a gallery of real time data APIs, was [1Forge](https://1forge.com).
