...
tags:
  ...
  - Links
image: >-
  https://kinlane-images.s3.amazonaws.com/apievangelist/json-home/json-home-widget-example.png
---
I'm have finally dedicated some time to learning more about [Home Documents for HTTP APIs, or simply JSON Home](https://tools.ietf.org/html/draft-nottingham-json-home-06). I see JSON Home as a nice way to bring together the technical components for an API, very similar to what I've been trying to accomplish with APIs.json. One of the biggest differences I see is that I'd say APIs.json was born out of the world of open data and APIs, where JSON Home is born of the web (which actually makes better sense).
