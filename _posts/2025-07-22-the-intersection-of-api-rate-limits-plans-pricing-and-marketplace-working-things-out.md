...
published: true
layout: post
title: The Intersection of API Rate Limits, Plans & Pricing, and Marketplace Working Things Out
...
The intersection of API rate limits, plans, pricing, and marketplace will continue to heat up in the age of artificial intelligence, and you can see this in action with the recent [Slack rate limit changes for non-marketplace apps](https://api.slack.com/changelog/2025-05-terms-rate-limit-update-and-faq), which is spelled out via their [pricing](https://slack.com/pricing)), [rate limits](https://api.slack.com/apis/rate-limits), and [marketplace review process](https://docs.slack.dev/slack-marketplace). The API service providers who are further along in their API management journey will fare much better in the API consumer environment that has emerged with all the AI agent hustling occurring right now.

[API service composition](https://apievangelist.com/2015/12/03/what-is-api-service-composition/) and [knowing your API consumer](https://apievangelist.com/2025/05/05/know-your-api-consumers/) is nothing new, but it is something that many API producers have taken short cuts on because it is something that takes work and building awareness throughout the API lifecycle, but also with the feedback loops you have with your API consumers. Now that the volume on API consumption has been cranked up to 11, those who haven't been doing this work are going to chewed up and spit out by the denial of service attacks produced by the current artificial intelligence segment of the market--which is the loudest right now.
