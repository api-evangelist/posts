...
image: >-
  https://kinlane-images.s3.amazonaws.com/apievangelist/blog/api-integration.png
author:
  name: kinlane
tags:
  - Integration
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-documentation.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-dollar-sign.jpg)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-terms-conditions.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/oauth-logo.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-key.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-load-testing.jpeg)

**API Load Testing** - Testing, with added benefit of making sure an API will actually perform under a heavy load

![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-heart-monitor.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-camera.jpg)

**API Request Capture** - Providing the ability to capture a individual API request

![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-chat.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-editor.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-play.jpg)

**API Request Playback** - Recording and playing back captured API requests so that you can inspect the results

![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-retry.png)

**API Request Retry** - Enabling the ability to retry a captured API request and play back in current time frame

![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-scheduling.jpeg)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-analytics-2.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-dashboard.png)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-geo-pin.jpeg)

**Geolocation** - Combining of location when testing and proxying APIs from potentially multiple locations

![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-import-export.jpeg)
...
![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-localhost.png)

**LocalHost** - Opening up of a local web server to a public address, allowing for webhooks and other interactions

![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-stars.png)

**Rating** - Establishment of a ranking system for APIs, based upon availability, speed, etc.

![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/real-time-2.jpg)

**Real-Time** - Adding real-time elements to analytics, messaging and other aspects of API integration

![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-reports.png)

**Reports** - Common reports on how APIs are being used across multiple applications and user profiles

![](https://kinlane-images.s3.amazonaws.com/apievangelist/building-blocks/bw-team.jpg)
