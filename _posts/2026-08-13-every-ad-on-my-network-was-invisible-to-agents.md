...
API Evangelist already did content negotiation. There is a Cloudflare Worker in front of the whole network that reads that alternate link and serves markdown when you ask for it with `Accept: text/markdown`, `Vary` header and all. I built that months ago. Most of the channel was already standing.
