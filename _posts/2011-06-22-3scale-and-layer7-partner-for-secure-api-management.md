...
tags:
  ...
  - Scale
---
kinlane-productions2.s3.amazonaws.com [![](https://kinlane-images.s3.amazonaws.com/shared/api-service-providers/3scale-logo.jpg)](http://www.3scale.net/api-management/solution/ "3Scale API Management Platform")Two API service providers have brought their products together to deliver a more robust enterprise API solution. [3Scale API management platform](http://www.3scale.net/api-management/solution/ "3Scale API Management Platform") now integrates with [Layer7 Technologies XML security gateways](http://www.layer7tech.com/products/xml-gateway-overview "Layer7 Technolies XML Gateway").
...
[![](https://kinlane-images.s3.amazonaws.com/shared/api-service-providers/layer7-logo.png)](http://www.layer7tech.com/products/xml-gateway-overview "Layer7 Technolies XML Gateway")Enterprise API providers can use 3scale's plugin to issue API keys, policies and access rights that can be pushed and pulled between security gateways and 3scale's management dashboards.
