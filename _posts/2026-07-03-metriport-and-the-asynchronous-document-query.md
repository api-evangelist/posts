...
Here is the asynchronous core of that workflow, straight from the repo—starting the query, then polling a real status enum until the download reports complete:
...
All four Metriport workflows live in the repo at [api-evangelist/metriport/arazzo](https://github.com/api-evangelist/metriport/tree/main/arazzo), including the [patient document retrieval workflow](https://github.com/api-evangelist/metriport/blob/main/arazzo/metriport-patient-document-retrieval-workflow.yml) excerpted above.
