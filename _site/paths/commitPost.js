...
router.put('/', (req, resp)=>{ 
  ...
  // BEGIN PULL FILE
  var changes_sql = "SELECT DISTINCT file FROM post_changes WHERE postId = '" + postId + "' AND committed = 0";
  ...
  client.send(command).then(
    (data) => { 
      ...
      streamToString(data.Body).then(
        ...
        var path = '/repos/' + organization + '/posts/contents/' + file;
                  ...
                  fetch(github_url,options)
                    .then(function(response) {
                        ...
                        response.json().then(function(data) {   
                          ...
                          var update_changes = "UPDATE post_changes SET committed = 1 WHERE postId = '" + postId + "' AND file = '" + file + "'";
                          connection.query(update_changes, function (error, changes_results, fields) { 
                            ...
                            connection.query(changes_sql, function (error, changes, fields) { 
                              ...
                              // BEGIN PULL FILE
                              var changes_sql = "SELECT * FROM post_changes WHERE postId = '" + postId + "' AND committed = 1";
                              connection.query(changes_sql, function (error, changes, fields) { 
                                ...
                                fetch(github_url,options)
                                  .then(function(response) {
                                      ...
                                      response.json().then(function(data) {                                      
                                        ...
                                        var update_changes = "UPDATE posts SET changes = 0 WHERE id = '" + postId + "'";
                                        connection.query(update_changes, function (error, changes_results, fields) { 

                                          // BEGIN UPDATE CONTRACTS
                                          var update_changes = "DELETE FROM post_changes WHERE postId = '" + postId + "'";
                                          connection.query(update_changes, function (error, changes_results, fields) { 
